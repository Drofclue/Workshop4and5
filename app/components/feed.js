...
export default class Feed extends React.Component {
  constructor(props) {
    // super() calls the parent class constructor -- e.g React.Componentt's constructor
    super(props);
    // Set state's initial value.
    // Note that the constructor is the the ONLY place you should EVER set state directly
    // In all other places, use the 'setState' method instead.
    // Setting 'state' directly in other places with not trigger 'render()' to run,
    // so your program will have bugs.
    this.state = {
      // Empty feed.
      contents: []
